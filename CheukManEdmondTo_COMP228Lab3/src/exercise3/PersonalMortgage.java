...
public class PersonalMortgage extends Mortgage {
    public PersonalMortgage(String customerName, double amountOfMortgage, int term, double interestRate) {
        super(customerName, amountOfMortgage, term, interestRate);
        this.interestRate = interestRate + 2.0; //sets the interest rate to 1% over the current prime rate.
    }
